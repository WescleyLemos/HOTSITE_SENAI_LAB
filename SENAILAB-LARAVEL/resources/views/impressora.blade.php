...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/impressora.css')}}" type="text/css">
...
<body>
    ...
    <header class="cabecalho">
        <img src="./img/banner-impressora.png" alt="">
    ...
    <main>
        <div class="div-descricao">
            ...
            <img src="./img/Impressora3d-cortada.png" alt="impressora3d" data-anime="direita">
        </div>
        ...
        <div class="div-projetos">
            ...
            <div class="card-projetos p1">
                <img src="./img/Impressora3D.JPG" alt="">
                <p>Nome Projeto 1</p>
                <a href="">Downloads</a>
            </div>
